...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        Coded By Mr Knoxx           |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|          https://discord.gg/programmer           |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       ...
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " idk")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 17/3/2023")
       slowprint ("\033[1;33m" + "         [+] YouTube       =>\033[1;36m" + " MrKnoxx")
       slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " MrKnoxx")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "          [+] https://discord.gg/programmer [+]          ")
       slowprint ("\033[1;91m -----------------------------------------------")
